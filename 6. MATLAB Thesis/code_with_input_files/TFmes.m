...
r(1,1)=corr(Q(12,:)',Q(1,:)','rows','complete');
b=zeros(12,1);
for i=2:12
b(i,1)=r(i,1)*s(i,1)/s(i-1,1);
end
b(1,1)=r(1,1)*s(1,1)/s(12,1);

k=Q(12,7);
Qp=zeros(12,10000);
for j=1:10000
% Componente aleatorio
t = 0 + sqrt(1)*randn(12,1);
%Caudales 2018
Qp(1,j)=Qm(1,1)+b(1,1)*(k-Qm(12,1))+t(1,1)*s(1,1)*(1-r(1,1)^2)^0.5;
for i=2:12
...
Q9=quantile(Qp,0.025,2);
Q25=quantile(Qp,0.25,2);
Q50=quantile(Qp,0.50,2);
Q75=quantile(Qp,0.75,2);
Q91=quantile(Qp,0.975,2);
