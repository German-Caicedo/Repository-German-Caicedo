...
r(1,1)=corr(Q(53,:)',Q(1,:)','rows','complete');

b=zeros(53,1);
for i=2:53
b(i,1)=r(i,1)*s(i,1)/s(i-1,1);
end
b(1,1)=r(1,1)*s(1,1)/s(53,1);

k=Q(53,7);
Qp=zeros(53,1000);
for j=1:1000
% Componente aleatorio
t = 0 + sqrt(1)*randn(53,1);
%Caudales 2018
Qp(1,j)=Qm(1,1)+b(1,1)*(k-Qm(53,1))+t(1,1)*s(1,1)*(1-r(1,1)^2)^0.5;
for i=2:53
